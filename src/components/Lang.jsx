...
const Lang = () => {
  ...
  return (
    <div className="flex ml-4 items-center space-x-4">
      ...
      <button onClick={() => changeLanguage('en')} className="text-gray-700 text-xs font-montserrat hover:text-gray-900 border-b-2 border-transparent hover:border-gray-500">
        English
      </button>
