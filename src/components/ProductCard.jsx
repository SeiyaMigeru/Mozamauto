...
const ProductCard = ({product, handleCardClick}) => {
    return (
        ...
        >
            ...
            <div className="absolute text-center inset-0 bg-black bg-opacity-50 text-white text-2xl font-bold font-palanquin flex items-start pt-3 justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                {product.name}
            </div>
        </div>
    )
