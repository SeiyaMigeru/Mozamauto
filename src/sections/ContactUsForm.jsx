              ...
              <div class="grid gap-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      class="py-3 px-4 block w-full border-gray-200 outline outline-1 focus:outline-stone-800 outline-stone-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none "
                ...
                <div>
                  ...
                  <input
                    ...
                    autocomplete="email"
                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm outline outline-1 outline-stone-300 focus:outline-stone-800 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none "
                    placeholder="Email"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 outline outline-1 outline-stone-300 focus:outline-stone-800 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none "
