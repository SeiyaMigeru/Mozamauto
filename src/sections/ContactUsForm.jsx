            ...
            <button
              ...
              >
                <span class="flex">
                  ...
                  <span class="grow ms-6">
                    <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 ">Information Desk</span>
                    <span class="block mt-1 text-gray-800 ">For inquiries regarding the company's operating hours, feedback, appointment confirmation and complaints.</span>
                  </span>
                </span>
              </button>
              ...
              >
                <span class="flex">
                  ...
                  <span class="grow ms-6">
                    <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 ">Service Department</span>
                    <span class="block mt-1 text-gray-800 ">For truck maintenance, part replacement, service team availability, and gate pass requests.</span>
                  </span>
                </span>
              </button>
              ...
              >
                <span class="flex">
                  ...
                  <span class="grow ms-6">
                    <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800  ">Part-Sales Department</span>
                    <span class="block mt-1 text-gray-800 ">Request a quote for truck components from our reputable suppliers and manufacturers.</span>
                  </span>
                </span>
              </button>
              ...
              >
                <span class="flex">
                  <svg class="flex-shrink-0 mt-2 h-6 w-6 md:w-7 md:h-7 hs-tab-active:text-blue-600 text-gray-800 " xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>
                  <span class="grow ms-6">
                    <span class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800  ">Sales Department</span>
                    <span class="block mt-1 text-gray-800 ">For truck, trailer, industrial truck, oil, and tire quotations.0</span>
                  </span>
                </span>
              </button>
            </nav>
