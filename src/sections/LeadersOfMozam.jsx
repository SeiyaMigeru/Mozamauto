      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 ">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">ALCIDO CHIVAMBO</h3>
              <p class="text-xs uppercase text-gray-500">LOGISTICS</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 ">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">AMILTON MAKARANGA</h3>
              <p class="text-xs uppercase text-gray-500">LOGISTICS</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 ">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800">AMINA DUARTE</h3>
              <p class="text-xs uppercase text-gray-500">ACCOUNTANT</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">ANABELA CHENGERANI</h3>
              <p class="text-xs uppercase text-gray-500">ACCOUNTANT</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200 ">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">BALBINA MATIAS</h3>
              <p class="text-xs uppercase text-gray-500">ACCOUNTANT</p>
            </div>
          </div>
          ...
          <div class="mt-3 space-x-1">
            <a
              class="inline-flex justify-center items-center w-8 h-8 text-sm font-semibold rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none :text-gray-400"
              href="#"
            >
              <svg
                class="flex-shrink-0 w-3.5 h-3.5"
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">BERNARDO GOTINE</h3>
              <p class="text-xs uppercase text-gray-500">LOGISTICS</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            <div class="grow">
              ...
              <p class="text-xs uppercase text-gray-500">SALES REPRESENTATIVE</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">CHRISTIAN BERSALES</h3>
              <p class="text-xs uppercase text-gray-500">IT MANAGER</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">IZAIAS MEQUE</h3>
              <p class="text-xs uppercase text-gray-500">DRIVER</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            <div class="grow">
              ...
              <p class="text-xs uppercase text-gray-500">SERVICE OPERATION MANAGER</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">JOVÊNCIO AFONSO</h3>
              <p class="text-xs uppercase text-gray-500">HUMAN RESOURCES</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">JULIETA DULCE DRAVIDO</h3>
              <p class="text-xs uppercase text-gray-500">ACCOUNTANT</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            <div class="grow">
              ...
              <p class="text-xs uppercase text-gray-500">SERVICE ADMINISTRATOR</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">PAULINO WILLIAM</h3>
              <p class="text-xs uppercase text-gray-500">PART SALES ASSOCIATE</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">VALERIO RASUL</h3>
              <p class="text-xs uppercase text-gray-500">ACCOUNTANT</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            />
            <div class="grow">
              <h3 class="font-medium text-gray-800 ">YURAN NHAMUE</h3>
              <p class="text-xs uppercase text-gray-500">ACCOUNTANT (OJT)</p>
            </div>
          </div>
        ...
        <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
          <div class="flex items-center gap-x-4">
            ...
            <div class="grow">
              ...
              <p class="text-xs uppercase text-gray-500">PART-SALES REPRESENTATIVE</p>
            </div>
          </div>
