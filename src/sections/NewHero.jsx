...
const NewHero = () => {
    ...
    return (
      <div className={`flex mt-1 items-center justify-center ${fadeIn ? 'fadeIn' : ''}`}>
        <div className="relative w-full">
          <img src={NewHeroBG} alt="Background Hero" className="mx-auto h-auto" />
          <div className="absolute inset-0 bg-gray-700 opacity-30 rounded-3xl"></div>
          <div className={`absolute inset-0 flex justify-end p-10 slideUp ${fadeIn ? 'slideUp' : ''}`}>
            <div className="flex flex-col items-center justify-center gap-10">
              ...
              className="w-1/2 mt-10 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent
                   bg-gray-600 text-white hover:bg-gray-700 disabled:opacity-50 disabled:pointer-events-none"
